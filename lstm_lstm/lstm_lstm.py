...
def lstm_lstm(x_train, y_train, x_valid, y_valid, base_path, model_path):
    ...
    history = model_1.fit(x=x_train,y=y_train,batch_size=32,epochs=25,validation_data=valid_data,callbacks=[earlystop, checkpoint, learning_rate_reduction])
    end_time = time.time()
    ...
    return model_1, training_time_per_epoch